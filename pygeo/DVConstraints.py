...
class DVConstraints(object):
    ...
    def addThicknessConstraints2D(
        ...
        * If the surface formed by leList and teList is NOT precisely
        ...
        self.constraints[typeName][conName] = ThicknessConstraint(
            conName, coords, lower, upper, scaled, scale, self.DVGeometries[DVGeoName], addToPyOpt, compNames=compNames, applyIC=applyIC
        )
    ...
    def addLeTeConstraints(
        ...
        self.linearCon[conName] = LinearConstraint(
            conName, indSetA, indSetB, np.ones(n), np.ones(n), lower=0, upper=0, DVGeo=DVGeo, config=config, comp=comp
        )

    def addLinearConstraintsShape(
        self, indSetA, indSetB, factorA, factorB, lower=0, upper=0, name=None, config=None, DVGeoName="default", comp=None
    ):
        """
        ...
        self.linearCon[conName] = LinearConstraint(
            conName, indSetA, indSetB, factorA, factorB, lower, upper, self.DVGeometries[DVGeoName], config=config, comp=comp
        )
...
class ThicknessConstraint(GeometricConstraint):
    ...
    def __init__(self, name, coords, lower, upper, scaled, scale, DVGeo, addToPyOpt, compNames=None, applyIC=False):
        self.name = name
        self.coords = coords
...
class LinearConstraint(object):
    ...
    def __init__(self, name, indSetA, indSetB, factorA, factorB, lower, upper, DVGeo, config, comp):
